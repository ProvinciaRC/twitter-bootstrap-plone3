...
build:
	...
	recess --compile ${ASSETS_LESS} > ${ASSETS_DESTINATION}/css/styles.css
	recess --compress ${ASSETS_LESS} > ${ASSETS_DESTINATION}/css/styles.min.css
	...
	-cp -a ${ASSETS_JS}/*    ${ASSETS_DESTINATION}/js/
...
clean:
	-rm -r ${BOOTSTRAP_DESTINATION}
	-rm -r ${ASSETS_DESTINATION}
